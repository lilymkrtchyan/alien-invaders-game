...
SHIP_IMAGE    = 'ship-strip.png' #'ship.png'
...
ALIEN_ROWS    = 5 #change back to 5
# the number of aliens per row
ALIENS_IN_ROW  = 12 #change back to 12
...
ALIEN_SPEED = 1.0 #change back to 1.0
...
BOLT_SPEED  = 90 #change back to 10
